# 1. 사용자 게임 초기화 (배경화면, 게임이미지, 좌표, 속도, 폰드 등)
# 2. 이벤트 처리 (키보드, 마우스 등)
# 3. 게임 캐릭터 위치 정의
# 4. 충돌 처리
# 5. 화면에 그리기
...
# 화면 타이틀 설정
pygame.display.set_caption("DDONG 피하기")

# FPS
clock = pygame.time.Clock()

#########1. 사용자 게임 초기화 (배경화면, 게임이미지, 좌표, 속도, 폰트 설정)
...
# 똥 만들기
enemy = pygame.image.load("C:/SHproject/pygame_basic/enemy.png")
